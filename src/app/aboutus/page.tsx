      ...
      <section className="bg-[#013b94] text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg">
            Learn more about our company, our vision, and the amazing team that
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-700">
                To be the global leader in our industry, setting the standard
                for quality and innovation. Our vision is to make a positive
                impact on every customer we serve, every product we deliver, and
